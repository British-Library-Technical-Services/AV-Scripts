# This is the GUI version of process_metadata_patch.py
# The script will copy the process metadata from one SIP (src_sip_id) to another (dest_sip_id)
...
class MainFrame(wx.Frame):
    ...
    def __init__(self):
        super().__init__(parent=None, style=wx.DEFAULT_FRAME_STYLE ^ wx.RESIZE_BORDER | wx.STAY_ON_TOP, title="PATCHER", size=(200, 240))
        panel = wx.Panel(self)
